...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/Harris-Majeed/Airbnb-Price-Prediction.git
     ```
...
- If you encounter any issues during the installation process, Contact me at ```harismajeed299@gmail.com```
